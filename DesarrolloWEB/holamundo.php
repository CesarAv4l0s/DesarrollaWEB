...
<html lang="en">
<head>
    <!--Descripción: Primer Hola Mundo Con PHP
...
<div class="image"><img src="img/prog.gif" width="400" height="300" style="border: 3px solid #F5FCA0;
			border-radius: 10px; position: absolute; top: 270px; left: 900px;"></div>
...
<h3>➵ Ejemplo de Hola Mundo  ♪  Práctica 01 🎯</h3>

<div class="table">

<fieldset style="border-left:10px solid #00BFFF; border-top-left-radius:8px; border-bottom-left-radius:8px ; background: #E0FFFF;">
	<legend style="color: #9F5614; font-family: Snap ITC;"> <i class="fab fa-youtube" title="Inicio"></i> Mundo </legend>
    ...
    echo "<p style='font-family: Snap ITC; color:#671908;'>Hola a todos</p>";
    
    print(" <h4 style='font-family: Papyrus; color:#030B29;'>Bienvenido Al Mundo PHP</h4>");
    
    printf("<h4 style='font-family: Papyrus; color:#030B29;'>Soy Raseck</h4>");
